...
Ext.define('Songserver.view.auth.RegistrationForm', {
	...
	items : [{
		...
		html : 'Bitte registriere dich. Nach der Registration musst du zuerst<br> manuell freigeschaltet werden (ca. 1 Tag).<br> Bei Fragen kontaktiere uns bitte via <a href="mailto:lieder@adoray.ch">lieder@adoray.ch</a>.'
	}, {
		fieldLabel : 'Vorname',
		name : 'firstname',
		allowBlank : false,
	...
	buttons : [{
		...
		handler : function() {
			Songserver.AppContext.mainLayout
					.loadPanel("Songserver.view.auth.LoginForm");
		}
	}, {
				...
				success : function(form, action) {
					...
					Ext.Msg
							.alert(
									...
									'Deine Registration wurde erfolgreich entgegengenommen. Du wirst per E-Mail informiert, sobald wir dich manuell freigeschaltet haben.');
					Songserver.AppContext.mainLayout
							.loadPanel("Songserver.view.auth.LoginForm");
				},
