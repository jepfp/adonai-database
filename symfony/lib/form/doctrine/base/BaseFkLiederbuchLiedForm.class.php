...
/**
 * FkLiederbuchLied form base class.
 *
 * @method FkLiederbuchLied getObject() Returns the current form's model object
 *
 * @package    adonai
 * @subpackage form
 ...
 */
abstract class BaseFkLiederbuchLiedForm extends BaseFormDoctrine
{
